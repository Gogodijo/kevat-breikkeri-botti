const move = (msg) => {
  ...
  if(commandArgs.length == 1) {
    msg.channel.send("Anna komento seuraavasti: !siirrä \"roolin nimi\" \" vanhan kanavan nimi\" \"Uuden kanavan nimi\" \n" +
  ...
  if(usersWithRole.length == 0){
    msg.channel.send("Ei löytynyt käyttäjä. Tarkista rooli / uusi kanava")
    return
  }
